...
@section('content')
  ...
  <div id="parallax" class="paralax" style="background-image: url('{{ asset("images/Testimonials/hero_inner_beer_05.jpg") }}')">
    ...
    <div class="connoisseurs">
      ...
      <div class="samples-of-beers">
        <div class="one-beer reveal">
          <div class="beer-link">
            <a href="#"><img src="{{ asset("images/Testimonials/beer_highlight_01.png") }}" alt="BEER" /></a>
          </div>
          <div class="text">
            <h3>BERNARD RED</h3>
        ...
        <div class="one-beer reveal">
          <div class="beer-link">
            <a href="#"><img src="{{ asset("images/Testimonials/beer_highlight_02.png") }}" alt="BEER" /></a>
          </div>
          <div class="text">
            <h3>GOLDEN ALE</h3>
        ...
        <div class="one-beer reveal">
          <div class="beer-link">
            <a href="#"><img src="{{ asset("images/Testimonials/beer_highlight_03.png") }}" alt="BEER" /></a>
          </div>
          <div class="text">
            <h3>RED DUNKEL</h3>
        ...
        <div class="one-beer reveal">
          <div class="beer-link">
            <a href="#"><img src="{{ asset("images/Testimonials/beer_highlight_07.png") }}" alt="BEER" /></a>
          </div>
          <div class="text">
            <h3>LONDON PRIDE</h3>
...
<div id="movable-parallax" class="parallax" style="background-image: url('{{ asset("images/Testimonials/hero_testimonials.jpg") }}')">
