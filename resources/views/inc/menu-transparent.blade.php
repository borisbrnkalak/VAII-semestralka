...
<header class="header {{ Request::routeIs("testimonials-page") || Request::routeIs("edit-page") ? "white-header" : "" }}">
  <div class="logo">
    <img src=" {{ Request::routeIs("testimonials-page") || Request::routeIs("edit-page") ? asset("images/logo-black.png") : asset("images/logo-white.png") }}" alt=" LOGO" />
  </div>
